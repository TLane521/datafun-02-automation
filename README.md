...
uv run python src/datafun_02_automation/app_tamara.py
```
...
1. Rename `app_tamara.py` to reflect your name or alias.
...
2. Edit this README.md file to change the run command to call your file instead.
   Use CTRL+f to search for `app_tamara.py` and replace all occurrences exactly.
